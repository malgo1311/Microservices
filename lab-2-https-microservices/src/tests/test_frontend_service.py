...
class TestService(unittest.TestCase):
    ...
    def test_get_function(self):
        ...
        self.assertTrue( get_request(f"{main_url}/stocks/BoarCo") == 200, "Get request : Failed case 1")

        # Case 2: TEST CASE FOR CORRECT URL AND INCORRECT STOCK NAME
        self.assertTrue( get_request(f"{main_url}/stocks/Ash") == 400, "Get request : Failed case 2")

        # Case 3: TEST CASE FOR INCORRECT URL
        self.assertTrue( get_request(f"{main_url}/stcks/BoarCo") == 404, "Get request : Failed case 3")

        print("\nAll GET requests ran successfully which expected responses")
